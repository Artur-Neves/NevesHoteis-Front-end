...
paginaDeErro("405",`Hoje eu desenvolvi uma tela que serve tanto para mostrar uma possível menssagem 
...
function paginaDeConfirmacao(titulo, menssagem){
    document.body.style='height: 100%; background: url("/assets/img/fundoVerde.jpg") no-repeat; background-position: center; background-size: cover;';
